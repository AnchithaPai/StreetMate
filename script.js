const suppliers = [
  {
    ...
    products: [
      ...
      { name: "Urad Dal", price: "₹32/kg" },
      { name: "Chana Dal", price: "₹40/kg" },
      { name: "Groundnuts", price: "₹35/kg" },
...

  {
    ...
    products: [
      { name: "Milk", price: "₹65/litre" },
      { name: "Curd", price: "₹45/kg" },
      { name: "Paneer", price: "₹380/kg" },
      { name: "Cheese", price: "₹350/kg" },
      { name: "Butter", price: "₹350/kg" },
      { name: "Yogurt", price: "₹115/kg" },
      { name: "Ghee", price: "₹130/kg" }
    ],
    phone: "9991112233",
    link: "heritage.html"
  },
  ...
  
  {
    ...
    products: [
      ...
      { name: "Mint Leaves", price: "₹30/bunch" },
    ],
    phone: "9391716441",
    link: "Anju_Vegitables.html"  
  },
